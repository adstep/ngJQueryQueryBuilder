...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = angular.module('ngJQueryQueryBuilder', [])
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var doT = __webpack_require__(5);
...
/***/ function(module, exports) {
	...
	"use strict";
	var QUERY_BUILDER_CHANGE_EVENT_NAMES = [
	...
	var QueryBuilderController = (function () {
	    /** @ngInject */
	    function QueryBuilderController($element) {
	        var _this = this;
	        ...
	        $($element).queryBuilder(this.options);
	        this.builder = this.queryBuilderElement.queryBuilder;
	        $($element).on(QUERY_BUILDER_CHANGE_EVENT_NAMES.join(' '), function () {
	            console.log(_this.builder.validate());
	            console.log(_this.builder.getRules());
	        });
	    }
